...
#endif
#if (_WIN32_IE >= 0x0400)
#define PSH_WATERMARK		0x4000
#define PSH_USEHBMWATERMARK	0x010000
#define PSH_USEHPLWATERMARK	0x020000
#define PSH_STRETCHWATERMARK	0x040000
#define PSH_HEADER		0x080000
#define PSH_USEHBMHEADER	0x100000
#define PSH_USEPAGELANG		0x200000
#if (_WIN32_IE < 0x0500)
