...
#else
#define SYSTEM_COLOR_BASE_OFFSET 0
#endif
#define COLOR_3DDKSHADOW (SYSTEM_COLOR_BASE_OFFSET + 21)
#define COLOR_3DFACE (SYSTEM_COLOR_BASE_OFFSET + 15)
#define COLOR_3DHILIGHT (SYSTEM_COLOR_BASE_OFFSET + 20)
#define COLOR_3DHIGHLIGHT (SYSTEM_COLOR_BASE_OFFSET + 20)
#define COLOR_3DLIGHT (SYSTEM_COLOR_BASE_OFFSET + 22)
#define COLOR_BTNHILIGHT (SYSTEM_COLOR_BASE_OFFSET + 20)
#define COLOR_3DSHADOW (SYSTEM_COLOR_BASE_OFFSET + 16)
#define COLOR_ACTIVEBORDER (SYSTEM_COLOR_BASE_OFFSET + 10)
#define COLOR_ACTIVECAPTION (SYSTEM_COLOR_BASE_OFFSET + 2)
#define COLOR_APPWORKSPACE (SYSTEM_COLOR_BASE_OFFSET + 12)
#define COLOR_BACKGROUND (SYSTEM_COLOR_BASE_OFFSET + 1)
#define COLOR_DESKTOP (SYSTEM_COLOR_BASE_OFFSET + 1)
#define COLOR_BTNFACE (SYSTEM_COLOR_BASE_OFFSET + 15)
#define COLOR_BTNHIGHLIGHT (SYSTEM_COLOR_BASE_OFFSET + 20)
#define COLOR_BTNSHADOW (SYSTEM_COLOR_BASE_OFFSET + 16)
#define COLOR_BTNTEXT (SYSTEM_COLOR_BASE_OFFSET + 18)
#define COLOR_CAPTIONTEXT (SYSTEM_COLOR_BASE_OFFSET + 9)
#define COLOR_GRAYTEXT (SYSTEM_COLOR_BASE_OFFSET + 17)
#define COLOR_HIGHLIGHT (SYSTEM_COLOR_BASE_OFFSET + 13)
#define COLOR_HIGHLIGHTTEXT (SYSTEM_COLOR_BASE_OFFSET + 14)
#define COLOR_INACTIVEBORDER (SYSTEM_COLOR_BASE_OFFSET + 11)
#define COLOR_INACTIVECAPTION (SYSTEM_COLOR_BASE_OFFSET + 3)
#define COLOR_INACTIVECAPTIONTEXT (SYSTEM_COLOR_BASE_OFFSET + 19)
#define COLOR_INFOBK (SYSTEM_COLOR_BASE_OFFSET + 24)
#define COLOR_INFOTEXT (SYSTEM_COLOR_BASE_OFFSET + 23)
#define COLOR_STATIC (SYSTEM_COLOR_BASE_OFFSET + 25)
#define COLOR_MENU (SYSTEM_COLOR_BASE_OFFSET + 4)
#define COLOR_MENUTEXT (SYSTEM_COLOR_BASE_OFFSET + 7)
#define COLOR_SCROLLBAR (SYSTEM_COLOR_BASE_OFFSET + 0)
#define COLOR_WINDOW (SYSTEM_COLOR_BASE_OFFSET + 5)
#define COLOR_WINDOWFRAME (SYSTEM_COLOR_BASE_OFFSET + 6)
#define COLOR_WINDOWTEXT (SYSTEM_COLOR_BASE_OFFSET + 8)
#define COLOR_HOTLIGHT (SYSTEM_COLOR_BASE_OFFSET + 26)
#define COLOR_GRADIENTACTIVECAPTION (SYSTEM_COLOR_BASE_OFFSET + 27)
#define COLOR_GRADIENTINACTIVECAPTION (SYSTEM_COLOR_BASE_OFFSET + 28)
...
#endif
#ifdef _WIN32_WCE
#define KEYEVENTF_SILENT 0x00000004
#endif
...
static inline BOOL CheckDlgButton(HWND h, int i, UINT c) {
	return SendDlgItemMessageW(h, i, BM_SETCHECK, (WPARAM)(c), 0);
}
#else
...
#if (_WIN32_WINNT >= 0x0500 || _WIN32_WINDOWS >= 0x0410 || _WIN32_WCE >= 0x0400)
